...
import com.androidbigguy.easyandroid.refreshlayout.header.BezierCircleHeader;
...
public class CircleActivity extends BaseActivity {
    ...
    protected void initView() {
        ...
        lv = findViewById(R.id.cclv);
        tilte.setText("圆圈模式");
        refreshLayout = findViewById(R.id.rfycc);
        refreshLayout.setEnableFooterFollowWhenLoadFinished(true);
        refreshLayout.setRefreshHeader(new BezierCircleHeader(getApplication()));
        refreshLayout.setEnableFooterFollowWhenLoadFinished(true);;
