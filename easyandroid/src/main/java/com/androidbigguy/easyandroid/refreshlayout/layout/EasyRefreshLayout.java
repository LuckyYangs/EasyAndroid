package com.androidbigguy.easyandroid.refreshlayout.layout;
...
import com.androidbigguy.easyandroid.refreshlayout.layout.api.DefaultRefreshFooterCreator;
import com.androidbigguy.easyandroid.refreshlayout.layout.api.DefaultRefreshHeaderCreator;
import com.androidbigguy.easyandroid.refreshlayout.layout.api.RefreshContent;
...
import com.androidbigguy.easyandroid.refreshlayout.layout.api.RefreshInternal;
...
import com.androidbigguy.easyandroid.refreshlayout.layout.constant.DimensionStatus;
...
import com.androidbigguy.easyandroid.refreshlayout.layout.footer.BallPulseFooter;
import com.androidbigguy.easyandroid.refreshlayout.layout.header.BezierRadarHeader;
import com.androidbigguy.easyandroid.refreshlayout.layout.impl.RefreshContentWrapper;
import com.androidbigguy.easyandroid.refreshlayout.layout.impl.RefreshFooterWrapper;
import com.androidbigguy.easyandroid.refreshlayout.layout.impl.RefreshHeaderWrapper;
import com.androidbigguy.easyandroid.refreshlayout.layout.listener.OnLoadMoreListener;
import com.androidbigguy.easyandroid.refreshlayout.layout.listener.OnMultiPurposeListener;
import com.androidbigguy.easyandroid.refreshlayout.layout.listener.OnRefreshListener;
import com.androidbigguy.easyandroid.refreshlayout.layout.listener.OnRefreshLoadMoreListener;
import com.androidbigguy.easyandroid.refreshlayout.layout.listener.OnStateChangedListener;
import com.androidbigguy.easyandroid.refreshlayout.layout.util.DelayedRunnable;
...
import com.androidbigguy.easyandroid.refreshlayout.layout.util.ViscousFluidInterpolator;
...
import static com.androidbigguy.easyandroid.refreshlayout.layout.util.DensityUtil.dp2px;
import static com.androidbigguy.easyandroid.refreshlayout.layout.util.SmartUtil.fling;
import static com.androidbigguy.easyandroid.refreshlayout.layout.util.SmartUtil.getColor;
...
public class EasyRefreshLayout extends ViewGroup implements RefreshLayout, NestedScrollingParent, NestedScrollingChild {
...
//    protected int mFooterExtendHeight;  //扩展高度
    ...
    public EasyRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setNestedScrollingEnabled(ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableNestedScrolling, false));
        mDragRate = ta.getFloat(R.styleable.EasyRefreshLayout_srlDragRate, mDragRate);
        mHeaderMaxDragRate = ta.getFloat(R.styleable.EasyRefreshLayout_srlHeaderMaxDragRate, mHeaderMaxDragRate);
        mFooterMaxDragRate = ta.getFloat(R.styleable.EasyRefreshLayout_srlFooterMaxDragRate, mFooterMaxDragRate);
        mHeaderTriggerRate = ta.getFloat(R.styleable.EasyRefreshLayout_srlHeaderTriggerRate, mHeaderTriggerRate);
        mFooterTriggerRate = ta.getFloat(R.styleable.EasyRefreshLayout_srlFooterTriggerRate, mFooterTriggerRate);
        mEnableRefresh = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableRefresh, mEnableRefresh);
        mReboundDuration = ta.getInt(R.styleable.EasyRefreshLayout_srlReboundDuration, mReboundDuration);
        mEnableLoadMore = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableLoadMore, mEnableLoadMore);
        mHeaderHeight = ta.getDimensionPixelOffset(R.styleable.EasyRefreshLayout_srlHeaderHeight, density.dip2px(100));
        mFooterHeight = ta.getDimensionPixelOffset(R.styleable.EasyRefreshLayout_srlFooterHeight, density.dip2px(60));
        mHeaderInsetStart = ta.getDimensionPixelOffset(R.styleable.EasyRefreshLayout_srlHeaderInsetStart, 0);
        mFooterInsetStart = ta.getDimensionPixelOffset(R.styleable.EasyRefreshLayout_srlFooterInsetStart, 0);
        mDisableContentWhenRefresh = ta.getBoolean(R.styleable.EasyRefreshLayout_srlDisableContentWhenRefresh, mDisableContentWhenRefresh);
        mDisableContentWhenLoading = ta.getBoolean(R.styleable.EasyRefreshLayout_srlDisableContentWhenLoading, mDisableContentWhenLoading);
        mEnableHeaderTranslationContent = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableHeaderTranslationContent, mEnableHeaderTranslationContent);
        mEnableFooterTranslationContent = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableFooterTranslationContent, mEnableFooterTranslationContent);
        mEnablePreviewInEditMode = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnablePreviewInEditMode, mEnablePreviewInEditMode);
        mEnableAutoLoadMore = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableAutoLoadMore, mEnableAutoLoadMore);
        mEnableOverScrollBounce = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableOverScrollBounce, mEnableOverScrollBounce);
        mEnablePureScrollMode = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnablePureScrollMode, mEnablePureScrollMode);
        mEnableScrollContentWhenLoaded = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableScrollContentWhenLoaded, mEnableScrollContentWhenLoaded);
        mEnableScrollContentWhenRefreshed = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableScrollContentWhenRefreshed, mEnableScrollContentWhenRefreshed);
        mEnableLoadMoreWhenContentNotFull = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableLoadMoreWhenContentNotFull, mEnableLoadMoreWhenContentNotFull);
        mEnableFooterFollowWhenLoadFinished = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableFooterFollowWhenLoadFinished, mEnableFooterFollowWhenLoadFinished);
        mEnableClipHeaderWhenFixedBehind = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableClipHeaderWhenFixedBehind, mEnableClipHeaderWhenFixedBehind);
        mEnableClipFooterWhenFixedBehind = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableClipFooterWhenFixedBehind, mEnableClipFooterWhenFixedBehind);
        mEnableOverScrollDrag = ta.getBoolean(R.styleable.EasyRefreshLayout_srlEnableOverScrollDrag, mEnableOverScrollDrag);
        mFixedHeaderViewId = ta.getResourceId(R.styleable.EasyRefreshLayout_srlFixedHeaderViewId, View.NO_ID);
        mFixedFooterViewId = ta.getResourceId(R.styleable.EasyRefreshLayout_srlFixedFooterViewId, View.NO_ID);

        if (mEnablePureScrollMode && !ta.hasValue(R.styleable.EasyRefreshLayout_srlEnableOverScrollDrag)) {
            mEnableOverScrollDrag = true;
        }

        mManualLoadMore = ta.hasValue(R.styleable.EasyRefreshLayout_srlEnableLoadMore);
        mManualNestedScrolling = ta.hasValue(R.styleable.EasyRefreshLayout_srlEnableNestedScrolling);
        mManualHeaderTranslationContent = ta.hasValue(R.styleable.EasyRefreshLayout_srlEnableHeaderTranslationContent);
        mHeaderHeightStatus = ta.hasValue(R.styleable.EasyRefreshLayout_srlHeaderHeight) ? DimensionStatus.XmlLayoutUnNotify : mHeaderHeightStatus;
        mFooterHeightStatus = ta.hasValue(R.styleable.EasyRefreshLayout_srlFooterHeight) ? DimensionStatus.XmlLayoutUnNotify : mFooterHeightStatus;
...
//        mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
        ...
        int accentColor = ta.getColor(R.styleable.EasyRefreshLayout_srlAccentColor, 0);
        int primaryColor = ta.getColor(R.styleable.EasyRefreshLayout_srlPrimaryColor, 0);
        if (primaryColor != 0) {
            if (accentColor != 0) {
        ...
        if (!thisView.isInEditMode()) {
            ...
            if (!mManualNestedScrolling && !isNestedScrollingEnabled()) {
                post(new Runnable() {
                    @Override
                    public void run() {
                        final View thisView = EasyRefreshLayout.this;
                        for (ViewParent parent = thisView.getParent() ; parent != null ; ) {
                            if (parent instanceof NestedScrollingParent) {
                                View target = EasyRefreshLayout.this;
        ...
        AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                if (mRefreshListener != null) {
                    mRefreshListener.onRefresh(EasyRefreshLayout.this);
                } else if (mOnMultiPurposeListener == null) {
                    finishRefresh(3000);
                }
                if (mRefreshHeader != null) {
                    mRefreshHeader.onStartAnimator(EasyRefreshLayout.this, mHeaderHeight,  (int) (mHeaderMaxDragRate * mHeaderHeight));
                }
                if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    mOnMultiPurposeListener.onRefresh(EasyRefreshLayout.this);
...
//    }
    ...
    @Override
    public EasyRefreshLayout setFooterHeight(float heightDp) {
...
//    }
    ...
    @Override
    public EasyRefreshLayout setHeaderHeight(float heightDp) {
...
//    }
    ...
    @Override
    public EasyRefreshLayout setHeaderInsetStart(float insetDp) {
...
//    }
    ...
    @Override
    public EasyRefreshLayout setFooterInsetStart(float insetDp) {
...
//    }
     ...
     */
    @Override
    public EasyRefreshLayout setDragRate(float rate) {
        this.mDragRate = rate;
        return this;
    }
     ...
     */
    @Override
    public EasyRefreshLayout setHeaderMaxDragRate(float rate) {
...
//        this.mHeaderExtendHeight = (int) Math.max((mHeaderHeight * (mHeaderMaxDragRate - 1)), 0);
     ...
     */
    @Override
    public EasyRefreshLayout setFooterMaxDragRate(float rate) {
...
//        this.mFooterExtendHeight = (int) Math.max((mFooterHeight * (mFooterMaxDragRate - 1)), 0);
     ...
     */
    @Override
    public EasyRefreshLayout setHeaderTriggerRate(float rate) {
     ...
     */
    @Override
    public EasyRefreshLayout setFooterTriggerRate(float rate) {
     ...
     */
    @Override
    public EasyRefreshLayout setReboundInterpolator(@NonNull Interpolator interpolator) {
     ...
     */
    @Override
    public EasyRefreshLayout setReboundDuration(int duration) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableLoadMore(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableRefresh(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableHeaderTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableFooterTranslationContent(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableAutoLoadMore(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableOverScrollBounce(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnablePureScrollMode(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableScrollContentWhenLoaded(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableScrollContentWhenRefreshed(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableLoadMoreWhenContentNotFull(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableOverScrollDrag(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableClipHeaderWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setEnableClipFooterWhenFixedBehind(boolean enabled) {
     ...
     */
    @Override
    public EasyRefreshLayout setDisableContentWhenRefresh(boolean disable) {
     ...
     */
    @Override
    public EasyRefreshLayout setDisableContentWhenLoading(boolean disable) {
     ...
     */
    @Override
    public EasyRefreshLayout setRefreshHeader(@NonNull RefreshHeader header) {
     ...
     */
    @Override
    public EasyRefreshLayout setRefreshHeader(@NonNull RefreshHeader header, int width, int height) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public EasyRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer) {
     ...
     */
    @Override
    public EasyRefreshLayout setRefreshFooter(@NonNull RefreshFooter footer, int width, int height) {
        if (mRefreshFooter != null) {
     ...
     */
    @Override
    public EasyRefreshLayout getLayout() {
        return this;
    }
     ...
     */
    @Override
    public EasyRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
     ...
     */
    @Override
    public EasyRefreshLayout setOnLoadMoreListener(OnLoadMoreListener listener) {
     ...
     */
    @Override
    public EasyRefreshLayout setOnRefreshLoadMoreListener(OnRefreshLoadMoreListener listener) {
        this.mRefreshListener = listener;
        this.mLoadMoreListener = listener;
        this.mEnableLoadMore = mEnableLoadMore || (!mManualLoadMore && listener != null);
        return this;
    ...
    /**
     * 设置多功能监听器
     * @param listener 建议使用 {@link com.androidbigguy.easyandroid.refreshlayout.layout.listener.SimpleMultiPurposeListener}
     * @return SmartRefreshLayout
     */
    @Override
    public EasyRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
     ...
     */
    @Override
    public EasyRefreshLayout setPrimaryColors(@ColorInt int... primaryColors) {
        if (mRefreshHeader != null) {
     ...
     */
    @Override
    public EasyRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
        final View thisView = this;
    ...
    /**
     * 设置滚动边界
     * @param boundary 建议使用 {@link com.androidbigguy.easyandroid.refreshlayout.layout.impl.ScrollBoundaryDeciderAdapter}
     * @return SmartRefreshLayout
     */
    @Override
    public EasyRefreshLayout setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
     ...
     */
    @Override
    public EasyRefreshLayout setNoMoreData(boolean noMoreData) {
     ...
     */
    @Override
    public EasyRefreshLayout finishRefresh() {
     ...
     */
    @Override
    public EasyRefreshLayout finishLoadMore() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EasyRefreshLayout finishRefresh(int delayed) {
     ...
     */
    @Override
    public EasyRefreshLayout finishRefresh(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EasyRefreshLayout finishRefresh(int delayed, final boolean success) {
        postDelayed(new Runnable() {
            ...
            public void run() {
                if (mState == RefreshState.Refreshing && mRefreshHeader != null && mRefreshContent != null) {
                    ...
                    int startDelay = mRefreshHeader.onFinish(EasyRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshHeader instanceof RefreshHeader) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        if (mIsBeingDragged) {
                            ...
                            EasyRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mTouchY + mSpinner - mTouchSlop*2, 0));
                            EasyRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + mSpinner, 0));
                        }
                        if (mSpinner > 0) {
     ...
     */
    @Override
    public EasyRefreshLayout finishLoadMore(int delayed) {
     ...
     */
    @Override
    public EasyRefreshLayout finishLoadMore(boolean success) {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
     ...
     */
    @Override
    public EasyRefreshLayout finishLoadMore(int delayed, final boolean success, final boolean noMoreData) {
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (mState == RefreshState.Loading && mRefreshFooter != null && mRefreshContent != null) {
                    notifyStateChanged(RefreshState.LoadFinish);
                    final int startDelay = mRefreshFooter.onFinish(EasyRefreshLayout.this, success);
                    if (mOnMultiPurposeListener != null && mRefreshFooter instanceof RefreshFooter) {
                    ...
                    if (startDelay < Integer.MAX_VALUE) {
                        ...
                        if (mIsBeingDragged) {
                            ...
                            EasyRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_DOWN, mLastTouchX, mTouchY + offset + mTouchSlop * 2, 0));
                            EasyRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + offset, 0));
                        } else if (mTotalUnconsumed != 0) {
                            mDragDirection = 'h';
                            mTotalUnconsumed = 0;
                            final long time = System.currentTimeMillis();
                            EasyRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_CANCEL, mLastTouchX, mTouchY + offset, 0));
...
//                            SmartRefreshLayout.super.dispatchTouchEvent(obtain(time, time, MotionEvent.ACTION_MOVE, mLastTouchX, mTouchY + offset, 0));
     ...
     */
    @Override
    public EasyRefreshLayout finishLoadMoreWithNoMoreData() {
        long passTime = System.currentTimeMillis() - mLastOpenTime;
...
//                    }
        ...
        public ValueAnimator animSpinner(int endSpinner) {
            return EasyRefreshLayout.this.animSpinner(endSpinner, 0, mReboundInterpolator, mReboundDuration);
        }
