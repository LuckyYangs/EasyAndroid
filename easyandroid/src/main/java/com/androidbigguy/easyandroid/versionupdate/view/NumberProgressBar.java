package com.androidbigguy.easyandroid.versionupdate.view;
...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextColor = attributes.getColor(R.styleable.UpdateAppNumberProgressBar_progress_text_colors, default_text_color);
        mTextSize = attributes.getDimension(R.styleable.UpdateAppNumberProgressBar_progress_text_sizes, default_text_size);
        ...
        int textVisible = attributes.getInt(R.styleable.UpdateAppNumberProgressBar_progress_text_visibilitys, PROGRESS_TEXT_VISIBLE);
