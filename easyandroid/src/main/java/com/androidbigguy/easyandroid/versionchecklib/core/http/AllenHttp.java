package com.androidbigguy.easyandroid.versionchecklib.core.http;

import com.androidbigguy.easyandroid.versionchecklib.core.VersionParams;
...
public class AllenHttp {
    ...
    private static <T extends Request.Builder> T assembleHeader(T builder, VersionParams versionParams) {
        com.androidbigguy.easyandroid.versionchecklib.core.http.HttpHeaders headers = versionParams.getHttpHeaders();
        if (headers != null) {
            ALog.e("header:");
