package com.androidbigguy.easyandroid.photopreview;
...
import static com.androidbigguy.easyandroid.photopreview.PhotoPreview.EXTRA_CURRENT_ITEM;
import static com.androidbigguy.easyandroid.photopreview.PhotoPreview.EXTRA_PHOTOS;
import static com.androidbigguy.easyandroid.photopreview.PhotoPreview.EXTRA_SHOW_DELETE;
...
//      });
  ...
  public void updateActionBarTitle() {
    if (actionBar != null){ actionBar.setTitle(
        getString(R.string.__picker_image_index, pagerFragment.getViewPager().getCurrentItem() + 1, pagerFragment.getPaths().size()));
  }
  }
}
